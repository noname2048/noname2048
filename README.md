...
- 웹 분야를 열심히 공부해가고 있는 저년차 개발자입니다.
- 파이썬 벡엔드(Django, FastAPI, Next.js, NestJS, Laravel) 등의 기술을 다뤄보았습니다

## 경력
### Algorima | Software Enginner 
- 2022.07 ~ 2023.04 소프트웨어 벡엔드 엔지니어, 채용담당자를 위한 프로그램 개발
...
### Sellmate | 상품개발팀
- 2023.10 ~ 현재
- ClassicASP(*legacy)/IIS, Lavael, NestJS 사용
- 주문수집, 유지보수

### 사이드프로젝트 (현재 VKE에 올라갔던 서버들은 비활성화 되었습니다.)
